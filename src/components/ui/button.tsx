  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gold text-midnight font-semibold hover:bg-gold-dark shadow-gold hover:shadow-elevated",
        hero: "bg-gold text-midnight font-semibold hover:bg-gold-dark shadow-gold hover:shadow-elevated hover:scale-105",
        "hero-outline": "border-2 border-gold/30 bg-transparent text-gold hover:bg-gold/10 hover:border-gold font-semibold",
        magic: "bg-magic text-primary-foreground shadow-elevated hover:shadow-gold hover:scale-105",
      },
      size: {

        ...
        <div className="container-tight">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="rounded-3xl overflow-hidden shadow-elevated bg-secondary aspect-square flex items-center justify-center">
                <div className="text-center p-8">
                  <span className="text-6xl mb-4 block">🏰</span>
                  <p className="text-muted-foreground">Our team shopping at Disney World</p>
                </div>
              </div>
            </motion.div>
